...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  const responses = {
    "miss you": "অরেক বেডারে Miss না করে xan মেয়ে হলে বস PRIYO রে হাঙ্গা করো😶👻😘",
    ...
    "admin": "He is PRIYO তাকে সবাই 𝐏𝐑𝐈𝐘𝐎 𝐂𝐇𝐎𝐖𝐃𝐇𝐔𝐑𝐘 হিসেবে চিনে😘☺️",
    ...
    "thanks": "এতো ধন্যবাদ না দিয়ে আমার বস PRIYO রে তোর গার্লফ্রেন্ড টা দিয়ে দে..!🐸🥵",
    ...
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌প্রি'য়'র প্রি'য়'ত'মা💖",
